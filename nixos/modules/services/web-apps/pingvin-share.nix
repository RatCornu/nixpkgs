...
let
  ...
  inherit (lib) mkOption mkEnableOption mkIf mkPackageOption types;
in

{
  options = {
    services.pingvin-share = {
      ...
      backend = {
        package = mkPackageOption pkgs [ "pingvin-share" "backend" ] { };
      ...
      frontend = {
        package = mkPackageOption pkgs [ "pingvin-share" "frontend" ] { };
